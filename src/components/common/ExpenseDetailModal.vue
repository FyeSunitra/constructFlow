...
<template>
    ...
    >
        ...
        <div v-if="expense" class="flex flex-col gap-4">
            <!-- Status -->
            <span
                class="inline-flex items-center h-6 px-3 rounded-full text-xs font-semibold w-fit"
                :style="{
            ...
            <div class="grid grid-cols-2 gap-2">
                <div class="rounded-xl p-3" style="background: #f7f6f2">
                    <div class="text-xs text-gray-400 mb-1">โครงการ</div>
                ...
                <div class="rounded-xl p-3" style="background: #f7f6f2">
                    <div class="text-xs text-gray-400 mb-1">วันที่ยื่น</div>
                    <div class="text-sm font-medium text-gray-800">
                        {{ formatDate(expense.created_at) }}
                    </div>
                </div>
                <div class="rounded-xl p-3" style="background: #f7f6f2">
                    <div class="text-xs text-gray-400 mb-1">งบ Phase</div>
            ...
            <div>
                ...
                <div
                    class="rounded-xl p-3 text-sm text-gray-700 leading-relaxed"
            ...
            <div>
                ...
                <div
                    v-else
                    class="flex flex-col items-center justify-center py-8 rounded-xl gap-2"
                    style="background: #f7f6f2"
                >
                    <Icon
                        icon="lucide:image-off"
                        style="width: 24px; height: 24px; color: #d3d1c7"
                    />
            ...
            <div v-if="expense.documents?.length">
                ...
                <div class="flex flex-col gap-1.5">
                    <a
                        v-for="doc in expense.documents"
                        :key="doc.name"
                        :href="(doc as any).url"
                        target="_blank"
                    ...
                    >
                        ...
                        <span v-if="doc.size" class="text-xs text-gray-400">{{
                            doc.size
                        }}</span>
                        <Icon
        ...
        <template #footer>
            <div class="flex items-center justify-between gap-2">
                ...
                <div
                    v-if="isCEO && expense?.status === 'PENDING'"
                    class="flex gap-2"
                >
                    <NButton
                        style="border-color: #a32d2d; color: #a32d2d"
                        ghost
            ...
            <div v-if="showRejectInput" class="mt-3 flex gap-2">
                ...
                <NButton
                    ...
                    @click="
                        emit('reject', expense!.id, rejectNote);
                        emit('update:show', false);
                    "
                >
                    ยืนยัน
