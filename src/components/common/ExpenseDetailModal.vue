        ...
        <div v-if="expense" class="flex flex-col gap-4">
            ...
            <div>
                ...
                <div class="grid grid-cols-3 gap-2">
                    <div v-for="i in 3" :key="i" class="aspect-[4/3] rounded-xl flex items-center justify-center"
                        style="background:#E3E1D8">
                        <Icon icon="lucide:image" style="width:20px;height:20px;color:#B4B2A9" />
                    </div>
                </div>
            </div>
            ...
            <div v-if="expense.documents.length">
                ...
                <div class="flex flex-col gap-1.5">
                    <div v-for="doc in expense.documents" :key="doc.name"
                        class="flex items-center gap-2.5 rounded-lg px-3 py-2.5" style="background:#F7F6F2">
